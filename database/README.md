...
Verified locally on 2026-09-26: a fresh migration reset, 94 mobile tests, 62 API tests, 78 SQL assertions and 18 hosted-script assertions on the local database. Python lint and type checks pass.
